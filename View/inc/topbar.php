	...
	<nav class="navStyle">
		<div class="container">
			<div class="nav-wrapper">
				...
				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo">My Essential Box-Office</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<!-- anciennement Chapitres, devenu Chroniques -->
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="<?=ROOT_URL?>blog_chapters.html">Films</a></li>

					<?php if (empty($_SESSION['is_admin']) && empty($_SESSION['is_user'])): ?>
					<li><a href="<?=ROOT_URL?>blog_login.html" class="btn brickButton waves-effect waves-light">Connexion<i class="material-icons right">lock_open</i></a></li>
					<?php endif ?>
					...
					<?php if (!empty($_SESSION['is_admin']) || !empty($_SESSION['is_user'])): ?>
					<li><a href="<?=ROOT_URL?>?p=blog&amp;a=logout" class="btn brickButton waves-effect waves-light">Déconnexion<i class="material-icons right">lock_outline</i></a></li>
					<?php endif ?>
				</ul>
